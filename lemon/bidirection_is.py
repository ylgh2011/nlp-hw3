...
def line_match(f, e, t, q, fe_count, e_count, jilm_count, ilm_count):
    m = len(f)
    l = len(e)
...
def main():
    ...
    for iter_cnt in range(opts.iteration):
        ...
        for (n, (f, e)) in enumerate(bitext):
            # match e to f
            line_match(f, e, t_fe, q_fe, fe_count, e_count, jilm_fe_count, ilm_fe_count)
            # match f to e
            line_match(e, f, t_ef, q_ef, ef_count, f_count, jilm_ef_count, ilm_ef_count)
